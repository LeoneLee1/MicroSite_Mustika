...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1 mt-4">
        <!-- Dashboard -->
        <li
            class="menu-item {{ request()->is('beranda*') ? 'active' : '' }} {{ request()->is('comment*') ? 'active' : '' }} {{ request()->is('vote/view*') ? 'active' : '' }} {{ request()->is('viewNotification*') ? 'active' : '' }} {{ request()->is('ai') ? 'active' : '' }} mb-2">
